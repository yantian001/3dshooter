...
namespace TDTK {
	...
	public class UIEditor : Editor {
		...
		public override void OnInspectorGUI(){
			...
			cont=new GUIContent("Build Mode:", "The build mode to be used. Determine how player build a menu");
			...
			cont=new GUIContent("PauseGameInPerkMenu:", "Check to enable pause the game when perk menu is opened");
